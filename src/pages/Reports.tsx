    ...
    <div className="container max-w-5xl mx-auto px-4 py-6 w-full">
      <div className="flex flex-col mb-6">
        ...
        <p className="text-sm text-zinc-500 mt-1">
          Acompanhe as métricas de uso e consumo do estoque.
        </p>
      </div>
      ...
      <Card className="border-dashed border-2 shadow-none bg-zinc-50/50">
        <CardContent className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <h3 className="text-lg font-semibold text-zinc-900 mb-2">Módulo de Relatórios</h3>
          <p className="text-sm text-zinc-500 max-w-sm">
            A funcionalidade de Business Intelligence está em desenvolvimento para análise profunda
            do histórico de contagem.
          </p>
        </CardContent>
      </Card>
    </div>
